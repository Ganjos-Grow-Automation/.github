...
Detaillierte Anweisungen zur Installation und Konfiguration findest du in der [Installationsanleitung](https://github.com/Ganjos-Grow-Automation/gb_HomeAssistant/blob/main/INSTALL.md).

## Lizenz

Dieses Projekt steht unter der [MIT-Lizenz](https://github.com/Ganjos-Grow-Automation/gb_HomeAssistant/blob/main/LICENSE).

## Kontakt

Für Fragen oder Anregungen erreichst du uns über die [GitHub Discussions](https://github.com/orgs/Ganjos-Grow-Automation/discussions) oder unser Community-Forum auf [Discord](https://discord.gg/neJdSvxnPf).
...
* Hardware - Die kompatible Hardware findest ist [hier](https://github.com/Ganjos-Grow-Automation/gb_HomeAssistant/blob/main/HARDWARE.md) hinterlegt. 
